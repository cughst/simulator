...
void TcpTimeStepEnv::ScheduleNextStateRead()
{
  ...
  //   ;
  // put data such as segmentsAcked into shared memory for use by the RL algorithm.
  ...
  //Bytes in flight is the amount of data that has been sent but not yet acknowledged
  ...
  // output error or gdb information
